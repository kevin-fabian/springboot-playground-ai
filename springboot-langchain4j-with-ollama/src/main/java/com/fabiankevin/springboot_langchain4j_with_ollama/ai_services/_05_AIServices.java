...
class _05_AIServices {
    ...
    static class Date_and_Time_Extracting_AI_Service_Example {
        ...
        interface DateTimeExtractor {
            ...
            Instant extractDateTimeFrom(String text);
        }
        ...
        public static void main(String[] args) {
            ...
            DateTimeExtractor extractor = AiServices
                    .create(DateTimeExtractor.class, model);
            ...
            Instant dateTime = extractor.extractDateTimeFrom(text);
    ...
    static class AI_Service_with_System_and_User_Messages_loaded_from_resources_Example {
        ...
        interface TextUtils {
            ...
            @SystemMessage(fromResource = "/prompt_templates/translator-system-prompt-template.txt")
            @UserMessage(fromResource = "/prompt_templates/translator-user-prompt-template.txt")
            String translate(@V("text") String text, @V("language") String language);
        }
